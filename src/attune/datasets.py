...
HACKATHON_DATASET_NAMES = frozenset(
    {"BIDSleep", "WESAD", "CGMacros", "Bridge2AI-Voice", "DDI", "PAMAP2"}
)

HACKATHON_DATASETS: tuple[DatasetStub, ...] = tuple(
    dataset for dataset in DATASET_CATALOG if dataset.name in HACKATHON_DATASET_NAMES
)
