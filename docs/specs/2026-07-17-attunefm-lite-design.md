...
```text
wearables + context + voice + image + video
        |
        v
modality encoders
        |
...
multimodal fusion model
        |
        v
personal health-state embedding
        |
        +--> recovery capacity head
        +--> fatigue/readiness head
        +--> personal anomaly head
        +--> work-pattern burden head
        +--> metabolic/diet response head
        +--> medication/lifestyle response head
        +--> visible health change head
        +--> mobility/frailty change head
